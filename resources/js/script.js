    ...
    $.ajax({
        ...
        for (let i = 0; i < responseBrew.length; i++) {
            ...
            if ((brewLon !== null) && (brewLat !== null)) {
                ...
                //click event to close modal clear the map that was opened
                ...
                card.on("click", function (event) {
                    ...
                    if ((brewLon !== null) && (brewLat !== null)) {
                        //open modal, create map, and mark brewery location
                        activateModal();
                        toMap(brewLat, brewLon);
                        let marker = L.marker([brewLat, brewLon]).addTo(mymap);
                        //call yelp api to get brewery ID to get brewery information from yelp
                        ...
                        $.ajax({
                            ...
                            //call brewery id to get all of yelp data of specific business
                            ...
                            $.ajax({
                                ...
                                //append all the information about the brewey on the map marker's popup. 
